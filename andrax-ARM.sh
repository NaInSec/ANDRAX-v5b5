...
if [[ -e ${CHROOT_DIR}/bin/bash ]]; then
	...
	curl https://gitlab.com/crk-mythical/andrax-hackers-platform-v5-2/raw/master/compressed-core/andrax.r5-build5.tar.xz -o andraxcore.tar.xz

	echo "Extracting this shit"
	sudo tar --same-owner -p -h -xvJf andraxcore.tar.xz -C /opt/ANDRAX/
