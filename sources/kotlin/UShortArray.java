...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static boolean m301equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m312unboximpl());
    }
    ...
    public static boolean m300containsAllimpl(short[] sArr, Collection<UShort> collection) {
        ...
        for (Object next : iterable) {
            if (!(next instanceof UShort) || !ArraysKt.contains(sArr, ((UShort) next).m295unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
