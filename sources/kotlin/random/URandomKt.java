...
public final class URandomKt {
    ...
    public static final long nextULong(Random random, ULongRange uLongRange) {
        ...
        if (uLongRange.isEmpty()) {
            ...
            return m878nextULongjmpaWc(random, uLongRange.getFirst(), ULong.m157constructorimpl(uLongRange.getLast() + ULong.m157constructorimpl(((long) 1) & ExpandableGridView.PACKED_POSITION_VALUE_NULL)));
        } else {
            if (UnsignedKt.ulongCompare(uLongRange.getFirst(), 0) <= 0) {
                return nextULong(random);
            }
            long first = uLongRange.getFirst();
            long j = ((long) 1) & ExpandableGridView.PACKED_POSITION_VALUE_NULL;
            return ULong.m157constructorimpl(m878nextULongjmpaWc(random, ULong.m157constructorimpl(first - ULong.m157constructorimpl(j)), uLongRange.getLast()) + ULong.m157constructorimpl(j));
        }
    }
