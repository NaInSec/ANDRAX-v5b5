...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static boolean m68equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual((Object) bArr, (Object) ((UByteArray) obj).m79unboximpl());
    }
    ...
    public static boolean m67containsAllimpl(byte[] bArr, Collection<UByte> collection) {
        ...
        for (Object next : iterable) {
            if (!(next instanceof UByte) || !ArraysKt.contains(bArr, ((UByte) next).m62unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
