...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static boolean m206equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual((Object) jArr, (Object) ((ULongArray) obj).m217unboximpl());
    }
    ...
    public static boolean m205containsAllimpl(long[] jArr, Collection<ULong> collection) {
        ...
        for (Object next : iterable) {
            if (!(next instanceof ULong) || !ArraysKt.contains(jArr, ((ULong) next).m200unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
