...
public final class TestClock extends AbstractLongClock {
    ...
    private final void m974overflowLRDsOJo(double d) {
        throw new IllegalStateException("TestClock will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m966toStringimpl(d) + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
}
