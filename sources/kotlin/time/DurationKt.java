...
public final class DurationKt {
    ...
    private static final double m973timesmvk6XK0(int i, double d) {
        return Duration.m955timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m972timeskIfJnKk(double d, double d2) {
        return Duration.m954timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m928constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
