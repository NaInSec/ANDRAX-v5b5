...
public final class MeasureTimeKt {
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> function0) {
        Intrinsics.checkParameterIsNotNull(function0, "block");
        return new TimedValue<>(function0.invoke(), MonoClock.INSTANCE.markNow().elapsedNow(), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Clock clock, Function0<? extends T> function0) {
        ...
        Intrinsics.checkParameterIsNotNull(function0, "block");
        return new TimedValue<>(function0.invoke(), clock.markNow().elapsedNow(), (DefaultConstructorMarker) null);
    }
}
