    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m427contentToStringGBYM_sE(((UByteArray) t).m79unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m429contentToStringrL5Bavg(((UShortArray) t).m312unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m426contentToStringajY9A(((UIntArray) t).m148unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m428contentToStringQwZRm1k(((ULongArray) t).m217unboximpl()));
            } else {
