...
public final class UInt implements Comparable<UInt> {
    ...
    private static final int m84compareToVKZWuLQ(int i, long j) {
        return UnsignedKt.ulongCompare(ULong.m157constructorimpl(((long) i) & ExpandableGridView.PACKED_POSITION_VALUE_NULL), j);
    }
    ...
    private static final long m105plusVKZWuLQ(int i, long j) {
        return ULong.m157constructorimpl(ULong.m157constructorimpl(((long) i) & ExpandableGridView.PACKED_POSITION_VALUE_NULL) + j);
    }
    ...
    private static final long m91divVKZWuLQ(int i, long j) {
        return UnsignedKt.m316ulongDivideeb3DHEI(ULong.m157constructorimpl(((long) i) & ExpandableGridView.PACKED_POSITION_VALUE_NULL), j);
    }
    ...
    private static final long m110remVKZWuLQ(int i, long j) {
        return UnsignedKt.m317ulongRemaindereb3DHEI(ULong.m157constructorimpl(((long) i) & ExpandableGridView.PACKED_POSITION_VALUE_NULL), j);
    }
    ...
    private static final long m128toULongimpl(int i) {
        return ULong.m157constructorimpl(((long) i) & ExpandableGridView.PACKED_POSITION_VALUE_NULL);
    }
