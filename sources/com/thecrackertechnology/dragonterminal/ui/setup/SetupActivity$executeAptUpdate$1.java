...
final class SetupActivity$executeAptUpdate$1 extends Lambda implements Function2<Integer, TerminalDialog, Unit> {
    final /* synthetic */ SetupActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SetupActivity$executeAptUpdate$1(SetupActivity setupActivity) {
        super(2);
    ...
    public final void invoke(int i, TerminalDialog terminalDialog) {
        ...
        if (i == 0) {
            ...
            this.this$0.aptUpdated = true;
            this.this$0.executeAptUpgrade();
            return;
        }
