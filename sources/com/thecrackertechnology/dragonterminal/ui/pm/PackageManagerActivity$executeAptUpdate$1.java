...
final class PackageManagerActivity$executeAptUpdate$1 extends Lambda implements Function2<Integer, TerminalDialog, Unit> {
    final /* synthetic */ PackageManagerActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PackageManagerActivity$executeAptUpdate$1(PackageManagerActivity packageManagerActivity) {
        super(2);
    ...
    public final void invoke(int i, TerminalDialog terminalDialog) {
        ...
        Toast.makeText(this.this$0, R.string.apt_update_ok, 0).show();
        terminalDialog.dismiss();
        this.this$0.refreshPackageList();
    }
}
