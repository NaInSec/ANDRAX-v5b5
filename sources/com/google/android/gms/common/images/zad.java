...
public final class zad extends zaa {
    ...
    public final boolean equals(Object obj) {
        ...
        zad zad = (zad) obj;
        ImageManager.OnImageLoadedListener onImageLoadedListener = (ImageManager.OnImageLoadedListener) this.zanc.get();
        ImageManager.OnImageLoadedListener onImageLoadedListener2 = (ImageManager.OnImageLoadedListener) zad.zanc.get();
    ...
    public final void zaa(Drawable drawable, boolean z, boolean z2, boolean z3) {
        ...
        if (!z2 && (onImageLoadedListener = (ImageManager.OnImageLoadedListener) this.zanc.get()) != null) {
