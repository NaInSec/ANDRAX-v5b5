...
public abstract class GmsClientSupervisor {
    ...
    protected static final class zza {
        ...
        public zza(String str, int i) {
            ...
            this.zzdt = SDL_1_3_Keycodes.SDLK_VOLUMEDOWN;
        }
    ...
    public boolean bindService(String str, ServiceConnection serviceConnection, String str2) {
        return zza(new zza(str, (int) SDL_1_3_Keycodes.SDLK_VOLUMEDOWN), serviceConnection, str2);
    }

    public boolean bindService(ComponentName componentName, ServiceConnection serviceConnection, String str) {
        return zza(new zza(componentName, (int) SDL_1_3_Keycodes.SDLK_VOLUMEDOWN), serviceConnection, str);
    }

    public void unbindService(String str, ServiceConnection serviceConnection, String str2) {
        zzb(new zza(str, (int) SDL_1_3_Keycodes.SDLK_VOLUMEDOWN), serviceConnection, str2);
    }
    ...
    public void unbindService(ComponentName componentName, ServiceConnection serviceConnection, String str) {
        zzb(new zza(componentName, (int) SDL_1_3_Keycodes.SDLK_VOLUMEDOWN), serviceConnection, str);
    }
}
