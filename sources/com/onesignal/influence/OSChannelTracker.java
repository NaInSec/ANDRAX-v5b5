        ...
        if (str != null && !str.isEmpty()) {
            ...
            try {
                ...
                if (lastChannelObjectsReceivedByNewId.length() > channelLimit) {
                    ...
                    jSONArray = lastChannelObjectsReceivedByNewId;
                }
                OSLogger oSLogger3 = this.logger;
                oSLogger3.debug("OneSignal OSChannelTracker for: " + getIdTag() + " with channelObjectToSave: " + jSONArray);
                saveChannelObjects(jSONArray);
