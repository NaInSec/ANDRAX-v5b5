...
class BadgeCountUpdater {
    ...
    private static void updateFallback(OneSignalDb oneSignalDb, Context context) {
        Cursor query = oneSignalDb.query(OneSignalDbContract.NotificationTable.TABLE_NAME, (String[]) null, OneSignalDbHelper.recentUninteractedWithNotificationsWhere().toString(), (String[]) null, (String) null, (String) null, (String) null, NotificationLimitManager.MAX_NUMBER_OF_NOTIFICATIONS_STR);
