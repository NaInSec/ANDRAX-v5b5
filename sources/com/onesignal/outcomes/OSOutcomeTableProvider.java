...
public class OSOutcomeTableProvider {
    ...
    public void upgradeCacheOutcomeTableRevision1To2(SQLiteDatabase sQLiteDatabase) {
        String str = "_id,name" + "," + OneSignalDbContract.NotificationTable.COLUMN_NAME_NOTIFICATION_ID;
        String str2 = "_id,name" + "," + CACHE_UNIQUE_OUTCOME_COLUMN_CHANNEL_INFLUENCE_ID;
        try {
            sQLiteDatabase.execSQL("BEGIN TRANSACTION;");
