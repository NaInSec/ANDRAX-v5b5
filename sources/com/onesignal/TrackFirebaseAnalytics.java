...
class TrackFirebaseAnalytics {
            ...
            if (currentTimeMillis - lastReceivedTime.get() <= 120000) {
                ...
                if (atomicLong == null || currentTimeMillis - atomicLong.get() >= 30000) {
                    try {
                        ...
                        bundle.putString(OneSignalDbContract.NotificationTable.COLUMN_NAME_NOTIFICATION_ID, lastReceivedPayload.notificationID);
    ...
    public void trackOpenedEvent(OSNotificationOpenResult oSNotificationOpenResult) {
        ...
        try {
            ...
            bundle.putString("source", "OneSignal");
            bundle.putString("medium", OneSignalDbContract.NotificationTable.TABLE_NAME);
            bundle.putString(OneSignalDbContract.NotificationTable.COLUMN_NAME_NOTIFICATION_ID, oSNotificationOpenResult.notification.payload.notificationID);
