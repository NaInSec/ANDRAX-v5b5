...
public class Conversion {
    ...
    public static long intArrayToLong(int[] iArr, int i, long j, int i2, int i3) {
        ...
        if (((i3 - 1) * 32) + i2 < 64) {
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = (i4 * 32) + i2;
                j = (j & (~(ExpandableGridView.PACKED_POSITION_VALUE_NULL << i5))) | ((((long) iArr[i4 + i]) & ExpandableGridView.PACKED_POSITION_VALUE_NULL) << i5);
            }
            return j;
        }
    ...
    public static int shortArrayToInt(short[] sArr, int i, int i2, int i3, int i4) {
        ...
        if (((i4 - 1) * 16) + i3 < 32) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 16) + i3;
                i2 = (i2 & (~(SupportMenu.USER_MASK << i6))) | ((sArr[i5 + i] & UShort.MAX_VALUE) << i6);
            }
            return i2;
        }
    ...
    public static int byteArrayToInt(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        if (((i4 - 1) * 8) + i3 < 32) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 8) + i3;
                i2 = (i2 & (~(255 << i6))) | ((bArr[i5 + i] & UByte.MAX_VALUE) << i6);
            }
            return i2;
        }
    ...
    public static short byteArrayToShort(byte[] bArr, int i, short s, int i2, int i3) {
        ...
        if (((i3 - 1) * 8) + i2 < 16) {
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = (i4 * 8) + i2;
                s = (short) ((s & (~(255 << i5))) | ((bArr[i4 + i] & UByte.MAX_VALUE) << i5));
            }
            return s;
        }
    ...
    public static short[] intToShortArray(int i, int i2, short[] sArr, int i3, int i4) {
        ...
        if (((i4 - 1) * 16) + i2 < 32) {
            for (int i5 = 0; i5 < i4; i5++) {
                sArr[i3 + i5] = (short) ((i >> ((i5 * 16) + i2)) & SupportMenu.USER_MASK);
            }
            return sArr;
        }
