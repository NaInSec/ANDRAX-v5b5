...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (z) {
            while (i6 < childCount) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i13) + layoutParams5.extraPixels, KeyHandler.KEYMOD_CTRL), childMeasureSpec);
                }
                i6++;
            }
        }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, KeyHandler.KEYMOD_CTRL), makeMeasureSpec);
        return i5;
    }
