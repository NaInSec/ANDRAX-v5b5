...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (!z && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), KeyHandler.KEYMOD_CTRL), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), KeyHandler.KEYMOD_CTRL));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
    ...
    public static abstract class LayoutManager {
        ...
        public void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = KeyHandler.KEYMOD_CTRL;
            this.mHeightMode = KeyHandler.KEYMOD_CTRL;
        }
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), KeyHandler.KEYMOD_CTRL), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), KeyHandler.KEYMOD_CTRL));
        }
