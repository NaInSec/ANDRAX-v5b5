...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(round3 - round, KeyHandler.KEYMOD_CTRL), View.MeasureSpec.makeMeasureSpec(round4 - round2, KeyHandler.KEYMOD_CTRL));
