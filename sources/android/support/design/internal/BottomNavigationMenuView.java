...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, KeyHandler.KEYMOD_CTRL);
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i11], KeyHandler.KEYMOD_CTRL), makeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                i10 += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i10, View.MeasureSpec.makeMeasureSpec(i10, KeyHandler.KEYMOD_CTRL), 0), View.resolveSizeAndState(this.itemHeight, makeMeasureSpec, 0));
    }
