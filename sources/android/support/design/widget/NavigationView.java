...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            i = View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), this.maxWidth), KeyHandler.KEYMOD_CTRL);
        } else if (mode == 0) {
            i = View.MeasureSpec.makeMeasureSpec(this.maxWidth, KeyHandler.KEYMOD_CTRL);
        }
