...
public class TabLayout extends HorizontalScrollView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode2 == Integer.MIN_VALUE) {
            i2 = View.MeasureSpec.makeMeasureSpec(Math.min(dpToPx, View.MeasureSpec.getSize(i2)), KeyHandler.KEYMOD_CTRL);
        } else if (mode2 == 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(dpToPx, KeyHandler.KEYMOD_CTRL);
        }
        ...
        if (getChildCount() == 1) {
            ...
            if (z) {
                childAt.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), KeyHandler.KEYMOD_CTRL), getChildMeasureSpec(i2, getPaddingTop() + getPaddingBottom(), childAt.getLayoutParams().height));
            }
        }
    }
