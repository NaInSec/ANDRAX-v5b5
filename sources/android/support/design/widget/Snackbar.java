        ...
        public void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt.getLayoutParams().width == -1) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, KeyHandler.KEYMOD_CTRL), View.MeasureSpec.makeMeasureSpec(childAt.getMeasuredHeight(), KeyHandler.KEYMOD_CTRL));
                }
            }
        }
    }
