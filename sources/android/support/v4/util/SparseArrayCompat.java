...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public void delete(int r4) {
        /*
            ...
            int[] r0 = r3.mKeys
            int r1 = r3.mSize
            int r4 = android.support.v4.util.ContainerHelpers.binarySearch((int[]) r0, (int) r1, (int) r4)
        ...
        L_0x0017:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.util.SparseArrayCompat.delete(int):void");
    }
