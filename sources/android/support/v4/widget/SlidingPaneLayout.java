    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824) {
            if (!isInEditMode()) {
                ...
                size = SDL_1_2_Keycodes.SDLK_NUMLOCK;
            }
        } else if (mode2 == 0) {
            if (!isInEditMode()) {
                ...
                size2 = SDL_1_2_Keycodes.SDLK_NUMLOCK;
            }
        }
        boolean z = false;
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i16, KeyHandler.KEYMOD_CTRL);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, KeyHandler.KEYMOD_CTRL);
                }
                if (layoutParams.height == -2) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, KeyHandler.KEYMOD_CTRL);
                } else {
                    i12 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, KeyHandler.KEYMOD_CTRL);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), KeyHandler.KEYMOD_CTRL);
                                } else if (layoutParams2.height == -2) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, KeyHandler.KEYMOD_CTRL);
                                } else {
                                    i8 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, KeyHandler.KEYMOD_CTRL);
                                }
                                if (z2) {
                                    int i19 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i6 = i17;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i19, KeyHandler.KEYMOD_CTRL);
                                    if (i7 != i19) {
                                    ...
                                    i6 = i17;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i14))) / f)), KeyHandler.KEYMOD_CTRL), i8);
                                    i18++;
                                    i17 = i6;
                                    i5 = 8;
                                }
                            ...
                            if (!z5) {
                                i9 = KeyHandler.KEYMOD_CTRL;
                                i10 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), KeyHandler.KEYMOD_CTRL);
                            } else if (layoutParams2.height == -2) {
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i9 = KeyHandler.KEYMOD_CTRL;
                            } else if (layoutParams2.height == -1) {
                                i9 = KeyHandler.KEYMOD_CTRL;
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, KeyHandler.KEYMOD_CTRL);
                            } else {
                                i9 = KeyHandler.KEYMOD_CTRL;
                                i10 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, KeyHandler.KEYMOD_CTRL);
                            }
