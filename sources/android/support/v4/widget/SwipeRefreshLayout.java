...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int i, int i2) {
        ...
        View view = this.mTarget;
        if (view != null) {
            view.measure(View.MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), KeyHandler.KEYMOD_CTRL), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), KeyHandler.KEYMOD_CTRL));
            this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, KeyHandler.KEYMOD_CTRL), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, KeyHandler.KEYMOD_CTRL));
            this.mCircleViewIndex = -1;
